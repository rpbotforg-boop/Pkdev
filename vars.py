...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7992835160:AAFtC0QuQIBTvIRJKXz2X1pPh4RwSbC7YoA")

CREDIT = os.environ.get("CREDIT", "❤️‍🔥♡𝕶𝑰ᚻƓ ♡❤️‍🔥")
...
ADMINS = [int(x) for x in os.environ.get("ADMINS", "777756062").split()]  # Default to owner ID
